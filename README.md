...
![Dashboard](screenshots/CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0001.jpg)
...
│   ├── │── dimtasks.csv
│   ├── │── factissues.csv
│   ├── │── factprojectmetrics.csv
│   ├── │── facttaskprogress.csv
│   ├── │── factweatherimpact.csv
│   ├── │── vw_contractorperformance.csv
│   ├── │── vw_criticalpathrisk.csv
│   ├── │── vw_locationrisk.csv
│   ├── │── vw_projectrisksummary.csv
├── sql/
...
├── screenshots/
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0001.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0002.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0003.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0004.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0005.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0006.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0007.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0008.jpg
│   ├── CONSTRUCTION PROJECT DELAY RISK PREDICTION SYSTEM_page-0009.jpg
├── LICENSE
├── README.md
